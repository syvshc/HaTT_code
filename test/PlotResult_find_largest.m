function f = PlotResult_find_largest(file)
    ...
    errorbar(D_set, err_TTrounding, neg_TTrounding, pos_TTrounding,     'bo','markersize',6,'linewidth',1)
    ax = gca;
    ax.YScale = 'log';
    
    hold on
    
    errorbar(D_set, err_randorth, neg_randorth, pos_randorth, 'g^','markersize',6,'linewidth',1)
    errorbar(D_set, err_orthrand, neg_orthrand, pos_orthrand, 'm+','markersize',6,'linewidth',1)
    errorbar(D_set, err_twosided, neg_twosided, pos_twosided, 'c*','markersize',6,'linewidth',1)
    errorbar(D_set, err_HaTT, neg_HaTT, pos_HaTT,     'ks','markersize',6,'linewidth',1)
    errorbar(D_set, err_HaTT_no_svd, neg_HaTT_no_svd, pos_HaTT_no_svd, 'rx','markersize',6,'linewidth',1)
    ...
    errorbar(D_set, speedup_TTrounding,       neg_TTrounding,       pos_TTrounding,       'bo-','markersize',6,'linewidth',1);
    
    hold on
    
    errorbar(D_set, speedup_randorth,  neg_randorth,  pos_randorth,  'g^-','markersize',6,'linewidth',1);
    errorbar(D_set, speedup_orthrand,  neg_orthrand,  pos_orthrand,  'm+-','markersize',6,'linewidth',1);
    errorbar(D_set, speedup_twosided, neg_twosided, pos_twosided, 'c*-','markersize',6,'linewidth',1);
    errorbar(D_set, speedup_HaTT,       neg_HaTT,       pos_HaTT,       'ks-','markersize',6,'linewidth',1);
    errorbar(D_set, speedup_HaTT_no_svd, neg_HaTT_no_svd, pos_HaTT_no_svd, 'rx-','markersize',6,'linewidth',1);
    ...
    errorbar(D_set, times_TTrounding,       neg_TTrounding,       pos_TTrounding,       'bo-','markersize',6,'linewidth',1);

    hold on

    errorbar(D_set, times_randorth,  neg_randorth,  pos_randorth,  'g^-','markersize',6,'linewidth',1);
    errorbar(D_set, times_orthrand,  neg_orthrand,  pos_orthrand,  'm+-','markersize',6,'linewidth',1);
    errorbar(D_set, times_twosided, neg_twosided, pos_twosided, 'c*-','markersize',6,'linewidth',1);
    errorbar(D_set, times_HaTT,       neg_HaTT,       pos_HaTT,       'ks-','markersize',6,'linewidth',1);
    errorbar(D_set, times_HaTT_no_svd, neg_HaTT_no_svd, pos_HaTT_no_svd, 'rx-','markersize',6,'linewidth',1);
    ...
    % hold on
    % 
    % errorbar(D_set, times_dot,  neg_dot,  pos_dot,  'g^-','markersize',6,'linewidth',1);
    % errorbar(D_set, times_HBilinearForm,       neg_HBilinearForm,       pos_HBilinearForm,       'ks-','markersize',6,'linewidth',1);
    % errorbar(D_set, times_HBilinearForm_no_svd, neg_HBilinearForm_no_svd, pos_HBilinearForm_no_svd, 'rx-','markersize',6,'linewidth',1);
    % 
    % hold off
    % title("(d)")
    % xlabel('Dimension', 'FontSize', 18)
