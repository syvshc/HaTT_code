function tt = TTrandn(n, l)
%TTrandn generates a random tensor train of size [n] and rank [l]
...
%       the TT-ranks are equal to [l],
  ...
  for i = 1 : tt.d
    tt.core(tt.ps(i) : tt.ps(i + 1) - 1) = randn(tt.n(i) * tt.r(i) * tt.r(i + 1), 1) / sqrt(tt.n(i) * tt.r(i) * tt.r(i + 1));
  end
end